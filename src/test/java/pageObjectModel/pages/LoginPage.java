...
public class LoginPage{
    ...
    public static void enterCredentials(WebDriver driver){
        ...
        WebElement elementPassword = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector(passwordField))));
    ...
    public static void sendCredentials(WebDriver driver)
    {
        ...
        WebElement elementLoginBtn = driver.findElement(By.linkText(loginButton));
